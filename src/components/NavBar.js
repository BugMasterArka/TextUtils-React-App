...
// default datatype of the props
NavBar.propTypes = {
    // isRequired means the props have to be passed to the function(be it default or through function parameters)
    title: PropTypes.string.isRequired,
    aboutText: PropTypes.string.isRequired
}
// default values of the props i.e. the function arguments 
NavBar.defaultProps = {
